...
JP_sales = 0
for games in video_game_sales:
    NA_sales = NA_sales + games[NA_SALES]
    JP_sales = NA_sales + games[JP_SALES]
print(NA_sales, JP_sales)
if NA_sales > JP_sales:
    print ('NA_sales higher')
elif NA_sales == JP_sales:
    print ('NA_sales = JP_sales')
else: 
    print ('JP_sales higher', JP_sales)

nintendo_games = []
for game in video_game_sales:
    if game[PUBLISHER] == 'Nintendo':
        nintendo_games.append(game[NAME])
print (len(nintendo_games), nintendo_games)
